...
- Animation and motion design — explicitly deferred.
...
None. Every decision above was made interactively in the 2026-05-19 and 2026-05-20 brainstorm sessions.

---

## 7. Implementation references

- `docs/superpowers/specs/2026-05-08-nuke-design.md` — base game design.
- `docs/superpowers/mockups/{planning,action,reactions,round-summary}-screen.html` — the parchment-phone visual floor.
